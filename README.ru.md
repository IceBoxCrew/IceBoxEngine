...
**IceBox Engine вышел в релиз.** Текущая стадия — **Release 1.0**: лаунчер, редактор, апдейтер и рантайм стабильны, и на движке можно собирать и выпускать полноценные коммерческие игры на всех поддерживаемых платформах.
