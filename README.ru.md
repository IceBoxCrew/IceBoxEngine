...
- **Инструментарий** — Встроенный профилировщик Tracy, оверлеи статистики, справочник горячих клавиш и пайплайн сборки игры **Build Game** в один клик для всех поддерживаемых платформ.
